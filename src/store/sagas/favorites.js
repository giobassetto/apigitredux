...
export function* addFavorite(action) {
  try {
    ...
    if (isDuplicated) {
      yield put(FavoriteActions.addFavoriteError('Repositório já está nos seus favoritos'));
    } else {
    ...
    yield put(FavoriteActions.addFavoriteError('Repositório não encontrado'));
  }
}
